...
class PvsMImpossibleActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_pvs_mimpossible)
        ...
        * */
        ...
        // contador para as células do jogo (usado na função Random)
    ...
    fun mediumBotExe() {
        ...
        Timer().schedule(800) {
            ...
            if (bot.size < 4 && winner == 0) {
                ...
                /*
                * "inteligência" do bot de nível impossible
                * */
                ...
                if (player.size == 1) {
                    if (!player.contains(5)) {
                        ID = 5
                    } else if (!player.contains(7)) {
                        ID = 7
                    } else if (!player.contains(3)) {
                        ID = 3
                    } else if (!player.contains(1)) {
                        ID = 1
                    } else if (!player.contains(9)) {
                        ID = 9
                    }
                }
